...
import { IEkycApprovalPrinceProps } from "../IEkycApprovalPrinceProps";
...
export const Attachmentpage: React.FunctionComponent<IEkycApprovalPrinceProps> = (props: IEkycApprovalPrinceProps) => {
