...
import styles from './EkycApprovalPrince.module.scss';
import type { IEkycApprovalPrinceProps } from './IEkycApprovalPrinceProps';
...
export default class EkycApprovalPrince extends React.Component<IEkycApprovalPrinceProps> {
  public render(): React.ReactElement<IEkycApprovalPrinceProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.ekycApprovalPrince} ${hasTeamsContext ? styles.teams : ''}`}>
        <ParallaxProvider>
          <HashRouter>
