...
export interface IDashboardOps {
    getDashboardData(props: IEkycApprovalPrinceProps): Promise<IEKYC[]>;
  ...
  getDashboardItemById(listName: string ,id: number, props: IEkycApprovalPrinceProps): Promise<IEKYC>;
  insertDashboardData(item: IEKYC, props: IEkycApprovalPrinceProps): Promise<any>;
  updateDashboardData(id: number, item: IEKYC, props: IEkycApprovalPrinceProps): Promise<void>;
  preFillData(code: string, props: IEkycApprovalPrinceProps): Promise<{EmployeeName?: string; Department?: string}>;
...
export default function DashboardOps(): IDashboardOps {
    ...
    const getDashboardData = async ( props: IEkycApprovalPrinceProps): Promise<IEKYC[]> => {
    ...
    const getDashboardItemById = async (listName: string ,id: number, props: IEkycApprovalPrinceProps): Promise<IEKYC> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const preFillData = async (code: string, props: IEkycApprovalPrinceProps): Promise<{EmployeeName?: string; Department?: string}> => {
        try {
    ...
    const insertDashboardData = async (item: IEKYC, props: IEkycApprovalPrinceProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const updateDashboardData = async (id: number, item: IEKYC, props: IEkycApprovalPrinceProps): Promise<void> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const getAttachments = async (
        listName: string,
        itemId: number,
        props: IEkycApprovalPrinceProps
