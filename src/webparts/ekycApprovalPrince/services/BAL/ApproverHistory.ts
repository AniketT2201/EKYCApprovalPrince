...
export interface IDashboardOps {
    getHistoryData(ekycId: number,props: IEkycApprovalPrinceProps): Promise<IHistory[]>;
    insertHistoryData(item: KYCData, props: IEkycApprovalPrinceProps): Promise<any>;
...
export default function HistoryOps(): IDashboardOps {
    ...
    const getHistoryData = async (ekycId: number, props: IEkycApprovalPrinceProps): Promise<IHistory[]> => {
    ...
    const insertHistoryData = async (item: KYCData, props: IEkycApprovalPrinceProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
