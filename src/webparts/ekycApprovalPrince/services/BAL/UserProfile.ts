...
export interface UserProfileOps {
    getLoggUserProfile(props: IEkycApprovalPrinceProps): Promise<IUserProfile>;
}

export default function LoggUserProfileOps() {
    const spCrudOps = SPCRUDOPS();
        const getLoggUserProfile = async (props: IEkycApprovalPrinceProps): Promise<IUserProfile> => {
